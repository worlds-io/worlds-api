...
public class DeviceConnection implements java.io.Serializable {
    ...
    public DeviceConnection(PageInfo pageInfo, java.util.List<DeviceEdge> edges, int totalCount) {
    ...
    /**
     * The total count of devices matching the query, across all pages.
     */
    ...
    public static class Builder {
        ...
        public DeviceConnection build() {
            return new DeviceConnection(pageInfo, edges, totalCount);
        }
