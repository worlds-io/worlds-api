...
public class CreateEventChronicleInput implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final CreateEventChronicleInput that = (CreateEventChronicleInput) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, chronicleProducerId, description, timestamp, timezone, metadata, priority, status, labels, locations, validation, activityChronicleIds);
    }
