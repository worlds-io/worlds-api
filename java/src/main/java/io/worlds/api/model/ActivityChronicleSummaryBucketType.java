...
public class ActivityChronicleSummaryBucketType implements java.io.Serializable {
    ...
    public ActivityChronicleSummaryBucketType(org.springframework.graphql.data.ArgumentValue<SummaryBucketSize> size, java.util.List<ActivityChronicleSummaryBucketField> fields) {
        this.size = size;
        this.fields = fields;
    }
    ...
    public static class Builder {
        ...
        public ActivityChronicleSummaryBucketType build() {
            return new ActivityChronicleSummaryBucketType(size, fields);
        }
