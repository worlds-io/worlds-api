...
public class UpdateEventInput implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        final UpdateEventInput that = (UpdateEventInput) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, type, subType, startTime, endTime, position, timezone, metadata, snapshots, uploads, imageIds, clips, trackIds, properties, draft, validation, priority);
    }
    ...
    public static class Builder {
        ...
        public UpdateEventInput build() {
            return new UpdateEventInput(id, type, subType, startTime, endTime, position, timezone, metadata, snapshots, uploads, imageIds, clips, trackIds, properties, draft, validation, priority);
        }
